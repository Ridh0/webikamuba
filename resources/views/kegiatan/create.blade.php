    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <!-- Light table -->
                <div class="card-body">
                    <form method="post" action="{{ route('kegiatan.store') }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group{{ $errors->has('desc') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-desc">{{ __('Desc') }}</label>
                                <input type="text" name="desc" id="input-desc" class="form-control form-control-alternative{{ $errors->has('desc') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" value="{{ old('desc') }}" required autofocus>
