        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Tambah Data Pemerintahan</h3>
            </div>
            <!-- Light table -->
            <div class="card-body">
                        <form method="post" action="{{ route('pemerintah.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('kategori') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-email">{{ __('Kategori') }}</label>
                                <input type="text" name="kategori" id="input-email" class="form-control form-control-alternative{{ $errors->has('kategori') ? ' is-invalid' : '' }}" placeholder="{{ __('kategori') }}" value="{{ old('kategori', __('Bupati')) }}" required>
